// FILE: Assets/Scripts/Genes/Implementations/Payload/PoisonPayload.cs
using UnityEngine;
...
{
    [CreateAssetMenu(menuName = "Abracodabra/Genes/Payload/Poison", fileName = "Gene_Payload_Poison")]
